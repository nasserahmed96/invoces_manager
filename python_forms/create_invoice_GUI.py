...
class Ui_createInvoiceWindow(object):
    def setupUi(self, createInvoiceWindow):
        ...
        createInvoiceWindow.resize(1174, 929)
        ...
        self.employee_shares_sb.setMinimumSize(QtCore.QSize(120, 30))
        self.employee_shares_sb.setMaximumSize(QtCore.QSize(120, 30))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.employee_shares_sb.setFont(font)
        self.employee_shares_sb.setMaximum(100.0)
        self.employee_shares_sb.setProperty("value", 100.0)
        self.employee_shares_sb.setObjectName("employee_shares_sb")
        self.horizontalLayout_13.addWidget(self.employee_shares_sb)
        self.append_employee_btn = QtWidgets.QPushButton(self.invoice_basic_information_frame)
        self.append_employee_btn.setMinimumSize(QtCore.QSize(120, 30))
        self.append_employee_btn.setMaximumSize(QtCore.QSize(120, 30))
        self.append_employee_btn.setObjectName("append_employee_btn")
        self.horizontalLayout_13.addWidget(self.append_employee_btn)
        ...
        self.add_client_btn.setMaximumSize(QtCore.QSize(120, 30))
        ...
        self.employees_table_view.horizontalHeader().setStretchLastSection(True)
        ...
        self.search_products_layout.addWidget(self.product_category_cb)
        ...
        self.accessories_label.setMaximumSize(QtCore.QSize(156, 16777215))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.above_installation_label.setMaximumSize(QtCore.QSize(260, 16777215))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.invoice_total_line_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.invoice_total_line_edit.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        self.invoice_total_line_edit.setFont(font)
        self.invoice_total_line_edit.setReadOnly(True)
        self.invoice_total_line_edit.setObjectName("invoice_total_line_edit")
        self.total_layout.addWidget(self.invoice_total_line_edit)
        ...
        self.preview_btn.setMinimumSize(QtCore.QSize(115, 50))
        self.preview_btn.setMaximumSize(QtCore.QSize(115, 50))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(798, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, createInvoiceWindow):
        ...
        self.employee_shares_sb.setSuffix(_translate("createInvoiceWindow", "%"))
        self.append_employee_btn.setText(_translate("createInvoiceWindow", "Append"))
        ...
        self.invoice_total_line_edit.setText(_translate("createInvoiceWindow", "0"))
