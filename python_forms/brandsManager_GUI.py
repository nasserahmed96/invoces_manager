...
class Ui_brands_manager(object):
    def setupUi(self, brands_manager):
        ...
        self.create_btn.setMaximumSize(QtCore.QSize(150, 50))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, brands_manager):
        ...
        self.name_label.setText(_translate("brands_manager", "Name"))
        self.description_label.setText(_translate("brands_manager", "Description"))
        self.search_btn.setText(_translate("brands_manager", "Search"))
        self.create_btn.setText(_translate("brands_manager", "Create new brand"))
        self.delete_btn.setText(_translate("brands_manager", "Delete"))
        self.edit_btn.setText(_translate("brands_manager", "Edit"))
