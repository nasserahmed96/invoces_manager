...
class Ui_employee_management_window(object):
    def setupUi(self, employee_management_window):
        ...
        self.search_employee_btn.setMinimumSize(QtCore.QSize(200, 50))
        self.search_employee_btn.setMaximumSize(QtCore.QSize(300, 100))
        font = QtGui.QFont()
...
"")
        ...
        self.add_employee_btn.setMinimumSize(QtCore.QSize(200, 50))
        self.add_employee_btn.setMaximumSize(QtCore.QSize(300, 100))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setUnderline(False)
